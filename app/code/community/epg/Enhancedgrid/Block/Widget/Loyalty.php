 ...
 */
class epg_Enhancedgrid_Block_Widget_Loyalty extends Mage_Adminhtml_Block_Template {
	...
	protected function _getLoyaltyUrl() {
	    ...
	    $url_data["v"] = (string) Mage::getConfig()->getNode('modules/epg_Enhancedgrid/version');
