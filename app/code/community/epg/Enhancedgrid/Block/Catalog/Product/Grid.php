...
class epg_Enhancedgrid_Block_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct() {
        ...
        $this->setTemplate( 'epg/enhancedgrid/catalog/product/grid.phtml' );
        parent::__construct();
    ...
    /**
     * @return epg_Enhancedgrid_Model_Product_Grid_Settings_Columns
     */
    ...
    protected function _prepareCollection() {
        ...
        if ( ! $collection ) {
            ...
            $collection = new epg_Enhancedgrid_Model_Resource_Eav_Mysql4_Product_Collection();
        }
