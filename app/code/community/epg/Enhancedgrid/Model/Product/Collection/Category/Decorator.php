 ...
 *
 * @category   WDCA
 * @package    epg_Enhancedgrid
 * @copyright  Copyright (c) 2008-2011 WDCA (http://www.wdca.ca)
 * @license    http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class epg_Enhancedgrid_Model_Product_Collection_Category_Decorator extends epg_Enhancedgrid_Model_Collection_Decorator_Abstract {

    
    public function setCollection(epg_Enhancedgrid_Model_Resource_Eav_Mysql4_Product_Collection $collection) {
